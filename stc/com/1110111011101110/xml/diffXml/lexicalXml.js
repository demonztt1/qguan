...
/*var sertConst =  allNames();
/!*console.log(sertConst)
sertConst.forEach(function (node, index) {
    console.log(FLEX(node))
})*!/*/

/*
var fs = require('fs');

var data = fs.readFileSync('E:\\临时\\jc\\对比文件二\\CSCA350-353000-00M01-01-X_2_20180901.xml', 'utf8');
var lexxml =new LexXML();
var heap =lexxml.lex(data);
console.log(heap)*/
